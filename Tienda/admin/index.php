...
if(!isset($_SESSION['id'])){
    ...
    <body style="background: #a0a0a0;color:#fff">
    <center>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="avatars/yo.jpg" style="width:35px;height:35px" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="avatars/yo.jpg" style="width:35px;height:35px" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          ...
          <li>
              <a href="./?p=manejar_seguimiento">
                  <i class="fa fa-th"></i> <span>Manejar Seguimiento</span>
              </a>
          </li>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src=avatars/yo.jpg" style="width:35px;height:35px" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="v" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="avatars/yo.jpg" style="width:35px;height:35px" alt="user image" class="offline">
